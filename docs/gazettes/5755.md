{/* source: gazettes/5755.pdf */}
{/* sha256: beba437864f2588ad5b4b2844ac08b5b65957418b1b1844822a44be9ec6b36be */}
{/* converted: 2026-05-31 01:08:39 */}
...
| No. 234         | Communications Regulatory Authority of Namibia: Notice in terms of section 35 of the Communica- tions Act, 2009 (&#124;Act No. 8 of 2009) and Regulations 19 and 20 of the Regulations Regarding Licensing Procedures for Telecommunications and Broadcasting Service Licences and Spectrum Use Licences                                                                         | 4               |
...
4. (c) by electronic mail sent to legal@cran.na;
...
5. (a) pay a late payment penalty of 50% of the overdue amount; or
6. (b) surrender its licence or licences to the Authority.
...
8. (a) pay a penalty of  N$10,000-00 per day for each day calculated from the date its financial statements were due to the date of submission thereof; or
9. (b) surrender its licence or licences to the Authority.
- (6) If, within 6 months after due date, a licensee-
11. (a) fails to pay any levy due and payable in terms of these regulations;
...
2. Whenever documents are required to be delivered to the Authority, such documents must be delivered physically or electronically -
2. (a) hand-delivered to an employee of the Authority at its principal place of business, being Communication House, No. 56 Robert Mugabe Avenue, Windhoek;
3. (b) by post mailed to Private Bag 13309, Windhoek;
4. (c) by electronic mail sent to operations@cran.na;
5. (d) by facsimile faxed to  +264 61 222 790; or
6. (e) in any other manner or to any other address specified in writing by the Authority from time to time.
...
2. (a) fixed, mobile or broadband data services; or
3. (b) fixed and mobile voice services; or
4. (c) any electronic communications service that the Authority determines in writing.
...
2. (a) The services referred to in regulation (3);
3. (b) infrastructure and facilities for the provision of the services referred to in regulation 3;
4. (c) equipment and end user devices supporting the provision of the services referred to in regulation 3; and
5. (d) end-user training and skills development.
...
2. (a) persons with disabilities;
3. (b) elderly persons and other recipients of social grants; and
4. (c) any other categories of users able to justify the need for universal service access on merit.

## Telecommunications services and equipment

5. (1) A licensee must-
2. (a) make the services referred to in regulation 3 available to; and
3. (b) have  available  the  equipment  and  end-user  devices,  duly  type-approved  by  the Authority, necessary to support the provision of the services referred to in paragraph (a) in order to provide in the telecommunications needs of,
...
2. (a) small and medium enterprises and other informal business entities in both urban and rural communities;
3. (b) non-governmental organizations engaged in promoting democratic participation and social welfare;
4. (c) workers and communities in mines, farms, nature reserves and conservancies;
5. (d) registered and recognised organisations representing persons with disabilities; and
6. (e) households in both urban and rural areas.
...
4. (a) a separate account from the account established by the Authority for its operations;
5. (b) used to defray the expenses directly relating to the administration, control and accounting of the Fund;
6. (c) used to pay subsidies to licensees to subsidize universal service provision or the provision of infrastructure necessary for such service provision.
...
3. (a) strive to promote the goals of universal access and universal service provision as propounded in the Universal Service Policy as published in Government Gazette No. 5169, General Notice No. 82 on 08 April 2013 and the Act;
4. (b) regularly conduct research into and keep abreast of national and international ICT developments and of universal access and universal service provision initiatives;
5. (c) work  closely  with  other  departments  of  the  Authority  to  reach  its  objective  in monitoring and evaluating compliance with universal access and universal service provision obligations of relevant licensees ;
6. (d) request from relevant licensees any information, documentation or reports, as may be necessary to perform its functions;
7. (e) implement business processes including but not limited to the preparation of bid or tender documents, invitations to bid or tenders and communicating the outcomes of tender or bid processes;
8. (f) conduct project management for the implementation and completion of contracts or any projects as may be approved by the Authority;
...
2. (a) upon approval by the Chief Executive Officer for the payment of expenses connected to the administration, control and accounting of the Fund;
3. (b) upon a specific order by the Authority in terms of section 57(3) of the Act;
4. (c) upon the award of a tender or bid after the Authority has invited tenders or bids by notice in the Gazette and after following a competitive tender process for any purpose related to universal service provision;
5. (d) upon the award of a subsidy in terms of these regulations; or
...
7. (a) baseline information;
8. (b) measurable deliverables;
9. (c) timelines;
10. (d) regular reporting requirements;
11. (e) the conclusion of a service level agreement, where applicable;
12. (f) repair and maintenance obligations, where applicable;
13. (g) training services, where applicable;
14. (h) payment schedules based on achievement of project deliverables;
15. (i) monitoring and evaluation requirements;
16. (j) penalty clauses; and
17. (k) quality of service requirements, where applicable.
...
19. (a) within 30 days after acceptance of a tender, enter into an agreement with the Authority, unless such period is extended by agreement between the Authority and the bidder, or
20. (b) furnish security for the performance of the agreement, when required.
...
3. (a) schools and higher education institutions;
4. (b) state hospitals and state health facilities;
5. (c) emergency centres;
6. (d) registered and recognised organisations representing persons with disabilities;
7. (e) and any other projects as determined by the Authority
...
2. (a) comply with its obligations set out in regulation 3 to 7;
3. (b) submit any report, return or provide any information as required by the Authority within the period determined by the Authority in terms of these Regulations or, if such  period  has  been  extended  by  the Authority  under  regulation  14,  within  the extended period,
...
2. (a) issue to a licensee a written warning and final date for submitting outstanding reports, returns or information, as the case may be;
3. (b) require the licensee to implement a remedial plan within a time frame agreed with the Authority  and  submit  additional  information  about  the  manner  in  which  the licensee must comply with the regulations referred to in subregulation (1)(a);
4. (c) impose a penalty of not more than N$l0,000.00 for each day during which a licensee fails  to  submit  reports,  returns  or  information  as  required  by  the  Authority  in accordance with subregulation (2)(b);
5. (d) impose  a  penalty  of  not  more  than  N$500,000.00  for  submitting  or  causing  the submission of false or misleading information to the Authority;
6. (e) impose a penalty not exceeding N$1,000,000.00 for -
7. (i) each contravention of the regulations;
8. (ii) each repeated contravention of the regulations,
